...
@Entity
@Table(name = "employee", schema = "ts")
@SequenceGenerator(name = "emp_seq", sequenceName = "ts.emp_seq")
public class Employee {
    ...
    @JoinTable(name = "employee_role", schema = "ts", foreignKey = @ForeignKey(name = "ts.er_uk"), joinColumns = @JoinColumn(name = "er_emp_id"), inverseJoinColumns = @JoinColumn(name = "er_role_id"))
